...
<head>
    ...
    <link href="../userplat/lib/plugins/iCheck/custom.css" rel="stylesheet">
...
<script src="../userplat/lib/bootstrap/bootstrap.min.js?v=3.3.6"></script>
<!-- iCheck -->
<script src="../userplat/lib/plugins/iCheck/icheck.min.js"></script>
<script>
